...
class TestParseTime:
    ...
    def test_hhmmss_millis(self) -> None:
...
class TestOperations:
    ...
    def test_concat_round_trip(self) -> None:
    ...
    def test_concat_with_transition_round_trip(self) -> None:
    ...
    def test_fade_round_trip(self) -> None:
    ...
    def test_speed_round_trip(self) -> None:
    ...
    def test_parse_speed_operation(self) -> None:
...
class TestContentModels:
    def test_frame_result_round_trip(self) -> None:
    ...
    def test_silence_interval_round_trip(self) -> None:
    ...
    def test_audio_level_round_trip(self) -> None:
    ...
    def test_video_summary_round_trip(self) -> None:
