...
class TestTrim:
    def test_basic_trim(self, test_video_10s: Any, output_dir: Any) -> None:
    ...
    def test_trim_hhmmss(self, test_video_10s: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "trimmed2.mp4")
        result = trim(test_video_10s, start="00:00:02", end="00:00:06", output=out)
        assert result.success
        assert os.path.exists(out)

    def test_trim_start_after_end(self, test_video_10s: Any, output_dir: Any) -> None:
    ...
    def test_trim_beyond_duration(self, test_video_10s: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "bad.mp4")
        with pytest.raises(CutAgentError) as exc_info:
            trim(test_video_10s, start="0", end="999", output=out)
        assert exc_info.value.code == "TRIM_BEYOND_DURATION"

    def test_trim_keyframe_warning(self, test_video_10s: Any, output_dir: Any) -> None:
...
class TestSplit:
    def test_split_into_three(self, test_video_10s: Any, output_dir: Any) -> None:
    ...
    def test_split_single_point(self, test_video_10s: Any, output_dir: Any) -> None:
        prefix = os.path.join(output_dir, "seg")
        results = split(test_video_10s, points=["5"], output_prefix=prefix)
        assert len(results) == 2

    def test_split_beyond_duration(self, test_video_10s: Any, output_dir: Any) -> None:
        prefix = os.path.join(output_dir, "seg")
        with pytest.raises(CutAgentError) as exc_info:
...
class TestConcat:
    def test_concat_two_segments(self, test_video_10s: Any, output_dir: Any) -> None:
    ...
    def test_concat_same_file(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "doubled.mp4")
        result = concat([test_video, test_video], output=out)
        assert result.success

    def test_concat_crossfade(self, test_video_10s: Any, output_dir: Any) -> None:
        prefix = os.path.join(output_dir, "seg")
        segments = split(test_video_10s, points=["5"], output_prefix=prefix)
...
class TestReorder:
    def test_reverse_order(self, test_video_10s: Any, output_dir: Any) -> None:
        prefix = os.path.join(output_dir, "seg")
        segments = split(test_video_10s, points=["5"], output_prefix=prefix)
    ...
    def test_reorder_out_of_range(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "bad.mp4")
        with pytest.raises(CutAgentError) as exc_info:
...
class TestExtractStream:
    ...
    def test_extract_video(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "video.mp4")
        result = extract_stream(test_video, stream="video", output=out)
        assert result.success
        assert os.path.exists(out)

    def test_extract_invalid_stream(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "bad.mp4")
        with pytest.raises(CutAgentError) as exc_info:
...
class TestFade:
    def test_fade_in_out(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "faded.mp4")
        result = fade(test_video, out, fade_in=0.5, fade_out=0.5)
        assert result.success
        assert os.path.exists(out)

    def test_fade_invalid(self, test_video: Any, output_dir: Any) -> None:
...
class TestSpeed:
    def test_speed_up(self, test_video: Any, output_dir: Any) -> None:
    ...
    def test_slow_down(self, test_video: Any, output_dir: Any) -> None:
    ...
    def test_speed_invalid_zero(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "bad_speed.mp4")
        with pytest.raises(ValueError):
            speed(test_video, out, factor=0.0)

    def test_speed_invalid_too_slow(self, test_video: Any, output_dir: Any) -> None:
        out = os.path.join(output_dir, "bad_speed.mp4")
        with pytest.raises(ValueError):
