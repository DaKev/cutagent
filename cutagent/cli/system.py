...
def capabilities_payload() -> dict:
    ...
    return {
        ...
        "operations": {
            ...
            "crop": {
                "description": "Crop a rectangular region from a video's frame",
                "fields": {
                    "op": "'crop'",
                    "source": "str",
                    "x": "int (>= 0)",
            ...
            "resize": {
                "description": "Resize a video into a target canvas",
                "fields": {
                    "op": "'resize'",
                    "source": "str",
                    "width": "int (> 0)",
                    "height": "int (> 0)",
                    "fit": "'contain' | 'stretch' (default 'contain')",
                    "background_color": "str (default 'black'; only used for fit='contain')",
                },
                "supports_copy_codec": False,
                "edl_compatible": True,
            },
